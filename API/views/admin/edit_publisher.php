...
<main>
    ...
    <!-- TITLE -->
            ...
            <!-- SUBMIT BUTTON -->
                <div id="box_submit">
                    <input type="submit" value="Submit" form="form_publisher" id="submit_button">
                </div>
    ...
    <!-- FORM -->
            <?= "<form id='form_publisher' action='/WWW/PlayingAPP/API/admin/EditPublisherService/" . $id . "' method='post'>" ?>
                    ...
                    <div class="sub_box_attributes">
                        <div class="box">
                            ...
                            <div class="box_content">
                                <?= "<input type='text' name='name' value='" . $publisher->getName() . "'>" ?>
                            </div>
                        </div>
                    </div>
